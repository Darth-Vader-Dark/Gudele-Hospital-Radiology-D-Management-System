        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>City/State:</strong> {{ $patient->city ?? 'N/A' }} {{ $patient->state ? ',' . $patient->state : '' }}</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p><strong>Name:</strong> {{ $patient->emergency_contact ?? 'Not provided' }}</p>
        ...
        <div class="col-md-8">
            <ul class="nav nav-tabs mb-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="appointments-tab" data-bs-toggle="tab" data-bs-target="#appointments" type="button">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="appointments" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('registration.appointment.create') }}" class="btn btn-sm btn-primary float-end">
